...
<main>
		...
		<div class="row">
			...
			<div class="col-md-5 offset-1 ">
				...
				<div class="row" style="padding-top:4rem;">
					...
					<div class="col-md-10 police_akkurat">
						Je recherche une alternance dans le développement web pour mes
						4ème et 5ème années d'ingénieuries informatique à L'EPSI de Lyon.
					</div>
	...
	<section id="realisations">
		...
		<!-- groupe bouton --->
		<div class="row">
			<div class="col-md-9 col-ms offset-1">
