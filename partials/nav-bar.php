<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <ul class="nav justify-content-end">
    ...
    <!-- linkedin-->
      ...
      <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="https://www.linkedin.com/in/maxence-edet-503478179/" target="_blank"> 
      ...
      <!-- github-->
        <li class="nav-item">
          <a class="nav-link" href="https://github.com/edetmaxence/portfolio_edet_maxence" target="_blank">
